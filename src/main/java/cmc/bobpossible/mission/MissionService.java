...
public class MissionService {
    ...
    public void missionChallenge(Long missionId) throws BaseException, IOException {
        ...
        if (mission.getMissionGroup().getStore().getMember().getNotification().getMission()) {
            ...
            fcmService.sendMessageTo(firebaseToken.getValue(), "고객님이 미션을 도전했습니다!", mission.getMember().getName() + " ("+ mission.getMember().getPhone().substring(7) + ") 님이 현재 미션을 진행중입니다.", "ownerMissionChallenge", "");
