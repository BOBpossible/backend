...
public class ElasticApi {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Create a client.
        RestClientBuilder builder = RestClient.builder(new HttpHost("search-bobplace-domain-lk4pashmaek2mwqgy5hwyaud4m.ap-northeast-2.es.amazonaws.com", 9200, "https"))
        ...
        searchSourceBuilder.query(QueryBuilders.matchQuery("필드명", "검색어"));
