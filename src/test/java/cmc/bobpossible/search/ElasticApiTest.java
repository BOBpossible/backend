...
public class ElasticApiTest {
    ...
    private final String ELASTIC_INDEX = "auto_complete";
    ...
    public void 엘라스틱서치_POST_전송() {
        ...
        cmc.bobpossible.search.Test test = new cmc.bobpossible.search.Test();
        test.setSearch_string("죠스매스");
        test.setSearch_string2("죠스매스2");

        Map<String, Object> result = elasticApi.callElasticApi("POST", url, test, null);
